        ...
        description: (
          <ul>
            <li>
              ...
              <ul>
                <li>
                  <p>React Native libraries</p>
                  <ul>
                    <li>react-native-auto-typing-text</li>
                  </ul>
                </li>
              </ul>
              ...
              <ul>
                <li>
                  <p>Flutter libraries</p>
                  <ul>
                    <li>platform_utils</li>
                  </ul>
                </li>
              </ul>
            </li>
            ...
            <li>
              <p>Walter's Currency Converter</p>
              <ul>
                <li>Flutter for iOS and Android app</li>
                <li>Electron embed ReactJS web application for macOS app</li>
              </ul>
            </li>
            ...
            <li>
              <p>what the FOOD</p>
              <ul>
                <li>React Native for iOS and Android app</li>
              </ul>
            </li>

            <li>
              <p>My Gay Life (MGL): Gay chat</p>
              <ul>
                <li>Flutter for iOS and Android app</li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul>
                <li>
                  <p>Display connected Wifi name</p>
                  <ul>
                    <li>Electron</li>
                  </ul>
                </li>
                ...
                <li>
                  <p>Safari extension: Scroll to the top of the page</p>
                  <ul>
                    <li>SwiftUI and Javascript</li>
                  </ul>
                </li>
              </ul>
            </li>
